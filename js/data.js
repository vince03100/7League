...
// Risultati fase gironi
const GIORNATE = [
  {
    day:"Mercoledì 17 Giugno", label:"Giornata 1",
    matches:[
  ...
  {
    day:"Giovedì 18 Giugno", label:"Giornata 2",
    matches:[
...
const PROSSIME = [
  {
    day:"Venerdì 19 Giugno", label:"Giornata 3",
    matches:[
  ...
  {
    day:"Mercoledì 24 Giugno", label:"Quarti di Finale",
    matches:[
  ...
  {
    day:"Giovedì 25 Giugno", label:"Semifinali",
    matches:[
  ...
  {
    day:"Venerdì 26 Giugno", label:"Gran Finale",
    matches:[
